...
It does not replace `docs/product/strategic-roadmap.md`.
Instead:
- `docs/product/lean-roadmap.md` is the current operating-mode roadmap
- `docs/product/strategic-roadmap.md` is the strategic and growth-oriented roadmap
...
They stay in `docs/product/strategic-roadmap.md`, not here.
...
## Relationship To `docs/product/strategic-roadmap.md`

Use `docs/product/strategic-roadmap.md` when discussing:
...
Use `docs/product/lean-roadmap.md` when deciding:
- what to build next
