...
Current HTTPS monitor capabilities:
- HTTPS monitors can optionally record certificate expiry snapshots
...
- recent HTTPS-monitor history when validating SSL expiry warnings or recoveries
